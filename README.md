...
1. **Download the installer file**  
   Go to the download page linked above. Under the "Assets" section, look for a file ending with `.exe`. It will likely be named something like `vol-surface-engine-setup.exe`. Click it to download.
